    ...
    methods
        ...
        function Bm = breathmetrics(resp, srate, dataType)
            ...
            elseif strcmp(dataType, 'rodentAirflow')
                smoothWinsize = 10;
                SavitzkyFilter = true;
%             elseif strcmp(dataType, 'FastrodentAirflow')
%                 smoothWinsize = 10;
%                 SavitzkyFilter = true   ;                         
            ...
            if SavitzkyFilter 
                GolayFilter.Order = 2;
                GolayFilter.nSamples = 5;
                Bm.smoothedRespiration =    reshape([ sgolayfilt(resp,[ GolayFilter.Order  ] , [ GolayFilter.nSamples  ] ) ] ,[1], []);
            else
